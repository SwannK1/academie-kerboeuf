            ...
            {lyceeLevels.map((level) => {
              ...
              return (
                <Link key={level.href} href={level.href}>
                  <div className="group flex h-full flex-col rounded-md border border-ink/10 bg-ink/[0.045] p-6 transition hover:-translate-y-0.5 hover:border-jade/30 hover:bg-ink/[0.065]">
