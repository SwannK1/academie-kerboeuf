          ...
          <div className="mt-5 grid gap-5 lg:grid-cols-[1fr_auto] lg:items-end">
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm leading-6 text-muted">
                Accès rapide aux domaines, observables, situations et ressources
                prévues. Le site organise ; les PDF enseigneront.
              </p>
            </div>
            <div className="grid grid-cols-4 gap-2 sm:min-w-[28rem]">
              <QuickMetric label="Domaines" value={gsDomains.length} />
...
function QuickMetric({ label, value }: { label: string; value: number }) {
  return (
    <div className="rounded-md border border-ink/10 bg-ink/[0.04] px-3 py-2">
