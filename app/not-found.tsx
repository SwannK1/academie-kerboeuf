...
export default function NotFound() {
  return (
    <main id="contenu-principal" className="min-h-screen bg-[#f8f3e8] px-6 py-16 text-[#16213e]">
      <div className="mx-auto max-w-3xl rounded-3xl border border-[#d8c7a3] bg-ink/80 p-8 shadow-sm">
