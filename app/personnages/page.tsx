...
export const metadata: Metadata = {
  ...
  description:
    "Les personnages de l'Académie Kerboeuf — du CP à la 3e, avec des relais au lycée. Chaque profil porte une méthode, une atmosphère et un rôle pédagogique distinct.",
};
...
export default function PersonnagesPage() {
  ...
  return (
    <main>
      ...
      <PersonnageGallery professors={cardData} />
      ...
      <div className="mx-auto max-w-7xl">
        <div className="relative overflow-hidden rounded-md border border-white/10 bg-white/[0.025] p-10">
          ...
          <p className="mt-5 max-w-2xl text-sm leading-7 text-muted">
            ...
            de présentation — ils sont les gardiens de méthodes distinctes,
            d&rsquo;atmosphères de travail, de façons d&rsquo;entrer dans l&rsquo;apprentissage.
