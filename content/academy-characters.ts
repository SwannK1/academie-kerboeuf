...
export const academyCharacters: AcademyProfessorCharacter[] = [
  ...
  },
  {
    ...
    role: "guide",
    category: "level-guide",
    mainSubject: "Méthode documentaire",
    shortDescription:
      "Noisette guide les élèves de CM1 dans la lecture de documents. Elle apprend à repérer une information utile, puis à construire une réponse organisée à partir de ce qu'elle a trouvé.",
    learningFunction: [
      "Extraire l'information utile d'une carte, d'un texte ou d'un schéma",
      "Classer et relier des indices documentaires",
      "Construire une réponse organisée",
      "Préparer la transition vers les enquêtes de CM2",
    ],
    tone: "Calme, méthodique, légèrement énigmatique. Pose des questions sans donner les réponses trop vite.",
    pedagogicalTraits: [
      "Méthodique",
      "Curieuse",
      "Débrouillarde",
      "Patiente",
      "Valorise l'organisation et la trace écrite",
    ],
    levels: ["CM1"],
    associatedPlaceKeys: ["cartotheque-secrete", "bibliotheque-des-recits"],
    publicStatus: getPublicStatus("en construction"),
    siteUsage:
      "Présente sur les pages CM1 comme guide de niveau, en complément des professeurs de matière.",
  },
  {
    id: "esteban",
    slug: "esteban",
    ...
    learningFunction: [
      ...
      "Garder une trace claire des apprentissages",
      "Préparer la lecture de documents plus complexes",
    ],
    tone: "Précis, posé, discrètement créatif. Insiste sur la clarté et la régularité des traces produites.",
    pedagogicalTraits: [
      "Précis",
      "Curieux",
      "Méthodique",
