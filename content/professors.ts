...
const officialPersonalities: {
  ...
  },
  {
    ...
    symbol: "Plume précise",
    levelLabel: "Académie",
    cycle: "Personnalité officielle",
    accentColor: "gold",
    universe: "Bibliothèque des récits",
    personalityProfile: {
      dominantTraits: ["Calme", "Précise", "Bienveillante", "Patiente", "Exigeante sur la clarté"],
      strengths: ["Guide la lecture et l’écriture", "Valorise l’expression juste", "Installe la confiance à l’écrit"],
      energy: "Une énergie calme et enveloppante, attentive à chaque mot.",
      posture: "Elle enseigne par lecture progressive, écriture guidée et retour bienveillant.",
      interaction: "Elle fait circuler la parole avec douceur et rend chaque expression plus précise.",
      represents: "La langue française maîtrisée : lire, comprendre, écrire avec clarté.",
    },
  },
  {
    slug: "elian",
