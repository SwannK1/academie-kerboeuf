...
export const academyLevels: AcademyLevel[] = [
  ...
  },
  {
    ...
    professor: {
      slug: "esteban",
      name: "Esteban",
      role: "Guide principal du CE1",
      initial: "E",
      mainSubject: "Étude de la langue",
      symbol: "Compas",
      description:
        "Esteban aide les élèves de CE1 à observer une notion, à la nommer et à en garder une trace claire et réutilisable.",
      specialty: "Organiser les premières notions dans des repères clairs et progressifs.",
      visualMood: "Galerie des indices : repères codés, indices affichés et petits schémas de méthode.",
    },
    mood: {
      name: "Galerie des indices",
      description: "Des missions courtes pour consolider lecture, calcul et méthode.",
    },
    heroTitle: "CE1 avec Esteban",
    description:
      "Un parcours pour renforcer les automatismes et apprendre à expliquer ses réponses, avec Esteban comme guide et Gaston comme compagnon de méthode et d'autonomie.",
    subjects: academySubjects,
