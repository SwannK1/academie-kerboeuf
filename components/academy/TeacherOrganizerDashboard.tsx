    ...
    <div className="mt-10 grid gap-6">
      ...
      <OrganizerSection id="preparer-aujourdhui" title="Préparer aujourd’hui">
        <div className="grid gap-2 sm:grid-cols-2">
          <OrganizerLink href="#preparer-une-seance">
            Préparer une séance
          </OrganizerLink>
          <OrganizerLink href="/enseignants/emploi-du-temps">
            Consulter l’emploi du temps
          </OrganizerLink>
          <OrganizerLink href="#plan-de-classe">
            Ouvrir le plan de classe
          </OrganizerLink>
          <OrganizerLink href="#suivi-classe">
      ...
      <OrganizerSection id="organiser-annee" title="Organiser l’année">
        <div className="grid gap-2 sm:grid-cols-3">
          <OrganizerLink href="/enseignants/programmation/annuelle">
            Programmation annuelle
          </OrganizerLink>
          <OrganizerLink href="/enseignants/programmation/periode">
      ...
      <OrganizerSection id="quotidien" title="Ma classe au quotidien">
        <div className="grid gap-2 sm:grid-cols-2">
          <OrganizerLink href="#plan-de-classe">Plan de classe</OrganizerLink>
          <OrganizerLink href="#suivi-classe">Suivi de classe</OrganizerLink>
        </div>
      </OrganizerSection>
